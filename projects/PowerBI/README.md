...
This project analyzes survey responses from 630 data professionals worldwide to understand current trends in the data industry. The dashboard provides insights into salary distributions, job roles, demographic characteristics, programming language preferences, and workplace satisfaction.



Using Power BI, an interactive dashboard was developed to transform raw survey data into actionable business insights and industry benchmarks.
